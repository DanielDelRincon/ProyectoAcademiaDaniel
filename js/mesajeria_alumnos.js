...
function capturarMensaje(){
    ...
    //http://localhost/pooBBDD2022/webs/alumnoss/menualumnoss.html?mensaje=100
    mensaje = urlParams.get('mensaje');
    
    /** trabajando con los mensajes... */
    if(mensaje == "100"){
        verOcultar("alumnos dado de alta");
    }else if(mensaje == "101"){
        verOcultar("alumnos no dado de alta, verifique.");
    }else if(mensaje == "200"){
        verOcultar("alumnos dado de baja");
    }else if(mensaje == "201"){
        verOcultar("alumnos no dado de baja, verifique.");
    }else if(mensaje == "202"){
        verOcultar("alumnos no dado de baja, a petición del usuario.");
    }else if(mensaje == "300"){
        verOcultar("Regresa de consulta de alumnoss.");
    }else if(mensaje == "400"){
        verOcultar("alumnos modificada con éxito.");
    }else if(mensaje == "401"){
        verOcultar("alumnos modificada sin éxito.");
    }else if(mensaje == "402"){
