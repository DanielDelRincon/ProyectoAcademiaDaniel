                ...
                <?php
                    ...
                    while($tupla = mysqli_fetch_row($resultado)){
                        echo    "<tr><td>" . $tupla[0] . "</td>" .
                                "<td>" . $tupla[1] . "</td>" .
                                "<td>" . $tupla[2] . "</td>" .
                                "<td><a href='./MateriaBajaRegistro.php?id_materia=" . $tupla[0] . "'><button>Borrar</button></a></td></tr>";
                    }
                    echo "</tbody></table>";
                    if(!$resultado){
                        header("location:../webs/menuMateria.html?mensaje=300");
                    }
